...
import logoSmall from "../../public/assets/personal/logosmall.png";
      ...
      <div id="home" className="fix">
        <div className="slider-wrapper">
          ...
          {SlideList.map((value, index) => (
            // slide personal-portfolio-slider slider-paralax slider-style-3 d-flex align-items-center justify-content-center
            <div className="bgContainer" key={index}>
              <div className="MainContainer">
                <div className="containerMini">
                        ...
                        <div className={`inner`}>
                          <div className="textContainer">
                            ...
                            <h1 className="title text-left">
                              Hi, I’m Jone Doe <br />
                              <TextLoop>
                                <span className="title"> JS Developer.</span>
                                <span className="title"> UI/UX Designer.</span>
                                <span className="title"> Content Writter.</span>
                              </TextLoop>{" "}
                            </h1>
                            <h2 className="title text-left">based in USA.</h2>
                            {value.description ? (
                  ...
                  <img src={logoSmall} alt="" className="imgLogo" />
                </div>
              </div>
              <ParticleBackground />
              {/*  */}
